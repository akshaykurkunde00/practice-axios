...
const App = () => {
  ...
  useEffect(() => {
    axios
      .get("https://openlibrary.org/subjects/science_fiction.json?limit=5")
      ...
      const updatedBooks = books.map((book) =>
        book.key === updateBook.key
          ? {
              ...
              authors: [{ name: updateBook.author }],
            }
          : book
      );
  ...
  return (
    <div className="container">
      ...
      <p>
        i use the Open Library API, which provides access to a large amount of
        data about books and authors
      </p>
